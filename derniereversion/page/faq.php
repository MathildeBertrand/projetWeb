			...
			<div class="col-sm-2 col-md-6 col-lg-8">
					<div id="section1">
						...
						<ul style="list-style-type:none;">
							...
							<li class="faq-answer">ENZyclopedia is an enzyme database that provide informations about Enzyme. You can find informations about different enzymes, enzyme classification, reaction, cofactors...</li>

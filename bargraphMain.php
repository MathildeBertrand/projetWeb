...
<html>
	<!-- Recuperation de chartjs pour pouvoir faire des graphes -->
	...
	<!-- Mise en page -->
		...
		<center><div id="chart-container">
			...
			<script type="text/javascript" src="graph_users.js"></script>
		</center>
		...
		<script type="text/javascript" src="graph_top.js"></script>
		...
		<script type="text/javascript" src="graph_publi.js"></script>
